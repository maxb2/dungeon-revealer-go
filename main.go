...
func main() {
	...
	dmHandler := handler.NewDMHandler(maps)
	...
	chatHandler := handler.NewChatHandler(chat, broker)
	...
	mux.Handle("GET /notes", a.RequireRole(auth.RolePlayer)(http.HandlerFunc(notesHandler.List)))
	mux.Handle("GET /notes/search", a.RequireRole(auth.RolePlayer)(http.HandlerFunc(notesHandler.Search)))
	mux.Handle("GET /notes/{id}", a.RequireRole(auth.RolePlayer)(http.HandlerFunc(notesHandler.View)))
